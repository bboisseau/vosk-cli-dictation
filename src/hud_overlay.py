...
def run_hud_overlay(event_queue: queue.Queue, stop_event: threading.Event):
    ...
    def apply_language(_event=None):
        ...
        try:
            cmd = [
                '/home/bboisseau/Documents/Repos/vosk-cli-dictation/venv/bin/python3',
                '/home/bboisseau/Documents/Repos/vosk-cli-dictation/scripts/apply_extension_preferences.py',
                '--language', selected,
                '--shortcut-key', 'alt_l',
                '--tap-type', 'double',
            ]
